...
{
    const XML_PATH_PRODUCT_URL_USE_CATEGORY = 'marketing/seo/product_use_categories';

    const XML_PATH_USE_PRODUCT_CANONICAL_TAG = 'marketing/seo/product_canonical_tag';

    const XML_PATH_AUTO_GENERATE_MASK = 'marketing/fields_masks';
